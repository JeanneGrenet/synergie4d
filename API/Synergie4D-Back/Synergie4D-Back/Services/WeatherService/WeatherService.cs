...
namespace Synergie4D_Back.Services.WeatherService
{
    public class WeatherService : IWeatherService
    {
        ...
        public async Task<Weather> GetCurrentTemperatureAsync(string city)
        {
        ...
        public async Task<Weather> GetAverageTemperatureAsync(string city)
        {
            string apiKey = "a23d97464a974bd9860154322231405";
            string requestUrl = $"https://api.weatherapi.com/v1/forecast.json?key={apiKey}&q={city}";
            HttpResponseMessage response;
            ...
            return new Weather
            {
                ...
                WeatherDescription = jsonResponse.forecast.forecastday[0].day.condition.text
            };
        }
    }
}